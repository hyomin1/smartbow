      ...
      className={`
        ...
        ${
          isOnline
            ...
            : 'border-stone-800 bg-stone-900 opacity-40 cursor-not-allowed pointer-events-none'
        }
      `}
    >
      <div className='flex items-start justify-between gap-4'>
        <div className='flex flex-col gap-1'>
          <h3 className='text-xl sm:text-2xl lg:text-3xl font-semibold text-stone-200'>
            {name}
          </h3>
